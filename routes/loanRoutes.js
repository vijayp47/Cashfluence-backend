...
const {applyForLoan,getAllLoans, updateLoanStatus,cronJob, getLoanDetails,checkPendingPayments,loanCompletedStatus,loanDuration } = require('../controllers/loanController');
