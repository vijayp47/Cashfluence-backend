...
const {applyForLoan,getAllLoans, updateLoanStatus, getLoanDetails,loanCompletedStatus,checkLoanEligibility,loanDuration,getAllLoanOfSpecificUser } = require('../controllers/loanController');
...
router.get("/check-loan", checkLoanEligibility);
