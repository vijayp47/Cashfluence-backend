...
const getUserProfile = async (req, res) => {
  ...
  try {
    ...
    const user = await User.findOne({
      ...
      attributes: ['id', 'firstName', 'lastName', 'email', 'image'], // Specify attributes to retrieve
    });
...
module.exports = {
  ...
  verifyOtp,
  forgotPassword,
  resetPassword,contactSupport,changePassword,handleOTPAndUserProfileUpdate,upload,getUserProfile
};
